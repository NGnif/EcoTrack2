  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground border-none"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer hidden md:block text-sidebar-foreground h-screen transition-all duration-300",
           state === 'collapsed' ? 'w-[calc(var(--sidebar-width-icon)_+1rem)]' : 'w-[var(--sidebar-width)]'
        )}
        data-state={state}
      ...
      >
        <div
          data-sidebar="sidebar"
          className={cn(
            "flex h-full flex-col bg-card border-r fixed",
            state === 'collapsed' ? 'w-[calc(var(--sidebar-width-icon)_+1rem)]' : 'w-[var(--sidebar-width)]'
          )}
        >
          {children}
